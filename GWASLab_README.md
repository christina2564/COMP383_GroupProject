...
## Overview
This pipeline demonstrates how to harmonize GWAS summary statistics using GWASLab and run S-PrediXcan using a GWAS Catalog test file (GCST90568441).

GWASLab requires some manual input, including specifying column names for summary statistics. Additional preprocessing may be needed depending on the dataset.
